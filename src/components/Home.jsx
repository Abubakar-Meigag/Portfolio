    ...
    <div   name="home" className="w-full md:h-screen bg-[#0a192f] xs:pt-navbarMobile md:pt-[80px]">
      <div className="max-w-[1000px] mx-auto px-2 flex flex-col justify-center h-full">
        ...
        <h2 className="text-[20px]">I will bring:</h2>
              ...
              <li>Strong knowledge of <strong className="text-[#d4e0e5]">Linux</strong>  distributions and  <strong className="text-[#d4e0e5]">networking</strong> concepts, including <strong className="text-[#d4e0e5]">IP, CIDR, TCP, DHCP, DNS, UDP, and the OSI model</strong>.</li>
